...
%
op.path_to_main_state_copy = '/data2/states/ifm13/main/ifm13_main_2019_12_19'; %<--update
op.path_to_science_state_copy = '/data2/states/ifm13/science/ifm13_science_2019_12_19';  %<--update
...
op.maximum_mission_number = 500;  %<-check
...
op.min_dive_length = 250;  %<-shallow, might need to be shorter than this if minutes?maybe seconds?
...
op.file_with_aanderaa_optode_calibration_parameters = 'optode_00196_1206E_coeff'; %update

% GEOMAR coefficients
op.file_with_geomar_optode_calibration_parameters = 'opt_calcoeff_M4831_00196_01206E_2017033103_M135_CTD113_uch_CALID03'; %update

% file with CTD reference data
op.glider_reference_data = {};
op.mooring_reference_data = '';
op.ctd_press_reference_data = '../ctd_reference_data/glider_check_data_press.mat'; %update with own data
op.ctd_dens_reference_data = '../ctd_reference_data/glider_check_data_dens.mat';



% offsets. % to update based on optimization results
op.t_offset = 0;
op.s_offset = 0;
op.use_c_factor = 0;
op.oa_offset = 0;
