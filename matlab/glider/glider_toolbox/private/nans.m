...
% replace same values by other values
%
% GEOMAR SVN $Id: nans.m 668 2020-02-11 10:19:35Z gkrahmann@geomar.de $
%
% function [arr,ind]=nans(arr,newdummy,olddummy,[mode]);
%
% input  :  arr                 - data array
%           newdummy  [nan]     - new dummy
%           olddummy  [-99.0]   - old dummy
%                                 if longer than 1 search for
%                                 each of the values, --> mode=1
%           [mode]		        - 1 : search for == olddummy
...
%
% Example:    new_array = nans(old_array,NaN,-999,'==');
%             will replace all -999 by NaN
%
