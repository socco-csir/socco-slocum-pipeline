function [f_out] = RC_filterback_2points_vardt_vartau(f_in,time,tau0,tau_fact,vardep_tau,vardep_tau0)
%% function [f_out] =
%% RC_filterback_2points_vardt_vartau(f_in,time,tau0,tau_fact,vardep_tau,vardep_tau0)
% 
% GEOMAR SVN $Id: RC_filterback_2points_vardt_vartau.m 186 2016-07-04 14:13:01Z gkrahmann@geomar.de $
%
% function to convolute back to real data from low pass filtered data 
% assuming an exponential behaviour with time constant tau0 including a
% variable dependence
%
...
for i=2:len
    f_out(i) = (f_in(i)-f_in(i-1)*ef(i-1))/(1-ef(i-1));
end
